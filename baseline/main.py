...
def main():
    ...
    # CSV paths
    # --------------------------------------------------
    train_csv = f"C:/Users/beiba/Desktop/baseline-polysim/polysim-main/FOP/feature_tracker/{config.version}_train_{config.seen_lang}_mixed_10pct_clean.csv"
    test_csv = f"C:/Users/beiba/Desktop/baseline-polysim/polysim-main/FOP/feature_tracker/{config.version}_test_{config.seen_lang}.csv"
    unseen_csv = f"C:/Users/beiba/Desktop/baseline-polysim/polysim-main/FOP/feature_tracker/{config.version}_test_{config.unseen_lang}.csv"
