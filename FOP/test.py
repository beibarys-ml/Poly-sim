...
def main():
    ...
    unseen_test_csv = f"C:/users/beiba/Desktop/polysim-main/FOP/feature_tracker/{config.version}_test_{config.unseen_lang}.csv"
    ...
    checkpoint_path = "C:/users/beiba/Desktop/polysim-main/FOP/checkpoints/v3_German_alpha0.0_best.pt"
