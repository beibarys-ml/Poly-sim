...
def main():
    ...
    # CSV paths
    # --------------------------------------------------
    train_csv = f"C:/users/beiba/Desktop/polysim-main/FOP/feature_tracker/{config.version}_train_{config.seen_lang}.csv"
    test_csv = f"C:/users/beiba/Desktop/polysim-main/FOP/feature_tracker/{config.version}_test_{config.seen_lang}.csv"
    unseen_csv = f"C:/users/beiba/Desktop/polysim-main/FOP/feature_tracker/{config.version}_test_{config.unseen_lang}.csv"
